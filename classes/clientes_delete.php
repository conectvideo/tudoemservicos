 ...
 * Page class
 */
class clientes_delete extends clientes
{
	...
	// Page object name
	public $PageObjName = "clientes_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("clienteslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("clienteslist.php"); // Return to list
			}
		}
	}
