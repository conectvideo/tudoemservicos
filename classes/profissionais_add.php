 ...
 * Page class
 */
class profissionais_add extends profissionais
{
	...
	// Page object name
	public $PageObjName = "profissionais_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("idprofissionais") !== NULL) {
				$this->idprofissionais->setQueryStringValue(Get("idprofissionais"));
				$this->setKey("idprofissionais", $this->idprofissionais->CurrentValue); // Set up key
			} else {
				$this->setKey("idprofissionais", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("profissionaislist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					if (GetPageName($returnUrl) == "profissionaislist.php")
						$returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
					elseif (GetPageName($returnUrl) == "profissionaisview.php")
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("profissionaislist.php"), "", $this->TableVar, TRUE);
