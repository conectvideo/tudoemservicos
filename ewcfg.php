...
$CONFIG = [
	...
	"RANDOM_KEY" => 'Ap7hp2WOjMwckUlb', // Random key for encryption
	...
	"PROJECT_ID" => "{A004BB51-6011-47F7-9C22-37FF3884C079}", // Project ID (GUID)
	...
	"CONNECTION_INFO" => [
		"DB" => ["id" => "DB", "type" => "MYSQL", "qs" => "`", "qe" => "`", "host" => "192.168.15.11", "port" => 3306, "user" => "root", "pass" => "19741974", "db" => "agenda"],
		"agenda1" => ["id" => "agenda1", "type" => "MYSQL", "qs" => "`", "qe" => "`", "host" => "192.168.15.11", "port" => 3306, "user" => "root", "pass" => "19741974", "db" => "agenda", "new" => TRUE],
		"agenda2" => ["id" => "agenda2", "type" => "MYSQL", "qs" => "`", "qe" => "`", "host" => "192.168.15.11", "port" => 3306, "user" => "root", "pass" => "19741974", "db" => "agenda", "new" => TRUE]
	],
